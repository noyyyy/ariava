...
if (formatPairingCode('01234567') !== '0123-4567') throw new Error('pairing export failed');
...
const request: BridgePairWatchRequest = { pairingCode: formatPairingCode('01234567') };
