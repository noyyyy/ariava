...
import { SESSION_SNAPSHOT_ERROR_CODES, validateReplaceCurrentSessionsRequest } from '@ariava/protocol/session-snapshots';
...
if (SESSION_SNAPSHOT_ERROR_CODES[0] !== 'session_snapshot_stale' || typeof validateReplaceCurrentSessionsRequest !== 'function') throw new Error('session-snapshots export failed');
...
import { SESSION_SNAPSHOT_ERROR_CODES, validateReplaceCurrentSessionsRequest, type ReplaceCurrentSessionsRequest } from '@ariava/protocol/session-snapshots';
...
const snapshotValidator: (value: unknown) => ValidationResult<ReplaceCurrentSessionsRequest> = validateReplaceCurrentSessionsRequest;
