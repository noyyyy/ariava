...
const SAFE_DEV_LIFECYCLE_MODULES = [
  ...
  'command-router.ts',
  'daemon.ts',
  'daemon/command-workflow.ts',
  'daemon/daemon-errors.ts',
  'daemon/daemon-inputs.ts',
  'daemon/presence-workflow.ts',
  'daemon/runtime-composition.ts',
  'daemon/snapshot-policy.ts',
  'daemon/sync-workflow.ts',
  'dev-profile-cli.ts',
  'drivers/pi.ts',
  ...
  'state-store/runtime-reset.ts',
  'state-store/session-transitions.ts',
  'state-store/spool-transactions.ts',
  'state-store/state-codec.ts',
  'state-store/state-persistence.ts',
